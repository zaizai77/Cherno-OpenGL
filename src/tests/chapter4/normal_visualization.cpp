...
int main()
{
    ...
    Shader shader("res/shaders/chapter4/default.shader");
    Shader normalShader("res/shaders/chapter4/normal_visualization.shader");
    Model nanosuit("res/model/nanosuit/nanosuit.obj");
